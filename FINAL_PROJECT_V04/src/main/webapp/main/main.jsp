...
<!-- 웹폰트 관련 -->
<link rel="stylesheet" href="resources/css/web-fonts.css" type="text/css">
...
<!-- 페이지 수정 기능 관련 -->
<script src="resources/js/main-edit-functions.js"></script>

<!-- JQuery 테이블 플러그인 -->
<script src="resources/js/jquery-table.js"></script>

<!-- Canvas 관련 -->
<script type="text/javascript" src="resources/js/html5-canvas-drawing-app.js"></script>
</head>
